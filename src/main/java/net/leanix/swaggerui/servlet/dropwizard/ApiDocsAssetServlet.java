package net.leanix.swaggerui.servlet.dropwizard;
...
public class ApiDocsAssetServlet extends HttpServlet {
     ...
     * @param basePath the basePath to be used for swagger - if none is given,
     * then derive basePath from current request
     */
    public ApiDocsAssetServlet(String resourcePath,
        String uriPath,
        String indexFile,
    ...
    private CachedAsset loadAsset(
        String key,
        HttpServletRequest req) throws URISyntaxException, IOException
    {
        ...
        String newAsset = Resources.toString(
            ...
            Charset.forName("UTF-8")).replace("{{basePath}}", curBasePath);
